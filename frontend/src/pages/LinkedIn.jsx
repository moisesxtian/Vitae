  ...
  return (
    <div className="flex items-center justify-center px-4 py-6 sm:px-6 lg:px-8 m-auto">
      {!isLoading ? (
        ...
        <div className="w-full max-w-md justify-center text-center bg-white shadow-md rounded-xl p-6 space-y-4">
          <h2 className="text-xl font-semibold text-gray-800">
            Uploading Your LinkedIn Profile
          </h2>
          <Loader className="animate-spin h-8 w-8 text-accent2 mx-auto" />
